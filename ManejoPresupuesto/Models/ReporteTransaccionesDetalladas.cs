namespace ManejoPresupuesto.Models
{
    public class ReporteTransaccionesDetalladas
    {
        ...
        public decimal BalanceDepositos => TransaccionesAgrupadas.Sum(x => x.BalanceDepositos); //sumando los depositos
        public decimal BalanceRetiros => TransaccionesAgrupadas.Sum(x => x.BalanceDepositos); //sumando los retiros
        ...
        public class TransaccionesPorFecha
        {
            ...
            public decimal BalanceDepositos => 
                ...
                .Sum(x => x.Monto);
            public decimal BalanaceRetiros =>
