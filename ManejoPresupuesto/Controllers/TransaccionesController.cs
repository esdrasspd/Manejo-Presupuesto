...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController: Controller
    {
        ...
        public async Task<IActionResult> Semanal(int mes, int año)
        {
            ...
            var diasSegmentados = diasDelMes.Chunk(7).ToList(); //permite en pequeños arreglos los dias del mes
            ...
            agrupado = agrupado.OrderByDescending(x => x.Semana).ToList(); //ordenando de manera descedente
        ...
        public async Task<IActionResult> Mensual(int año)
        {
            ...
            if(año == 0)
            {
                año = DateTime.Today.Year; //año actual
            }
        ...
        [HttpGet]
        public async Task<FileResult> ExportarExcelPorMes(int mes, int año)//FileResult es descargar un archivo
        {
        ...
        public async Task<IActionResult> Crear(TransaccionCreacionViewModel modelo)
        {
            ...
            {
                modelo.Monto *= -1; //guardando como negativo
            }
        ...
        public async Task<IActionResult> Editar(int id, string urlRetorno = null)
        {
            ...
            var modelo = mapper.Map<TransaccionActualizacionViewModel>(transaccion); //mapeando la transaccion
        ...
        public async Task<IActionResult> Editar(TransaccionActualizacionViewModel modelo)
        {
            ...
            {
                return LocalRedirect(modelo.UrlRetorno); //redireccion a algo dentro del dominio
            }
        ...
        public async Task<IActionResult> Borrar(int id, string urlRetorno = null)
        {
            ...
            {
                return LocalRedirect(urlRetorno); //redireccion a algo dentro del dominio
            }
        ...
        private async Task<IEnumerable<SelectListItem>> ObtenerCuentas(int usuarioId)
        {
            ...
            return cuentas.Select(x => new SelectListItem(x.Nombre, x.Id.ToString())); //proyeccion
        }
        ...
        public async Task<IActionResult> ObtenerCategorias([FromBody] TipoOperacion tipoOperacion)
        {
            ...
            return Ok(categorias); //devuelve respuesta exitosa y en su cuerpo van las categorias
