...
namespace ManejoPresupuesto.Services
{
    ...
    public class ServicioReportes: IServicioReportes
    {
        ...
        {
            ViewBag.mesAnterior = fechaInicio.AddMonths(-1).Month; //hace 1 mes
            ViewBag.añoAnterior = fechaInicio.AddMonths(-1).Year; //hace de 1 año
            ViewBag.mesPosterior = fechaInicio.AddMonths(1).Month;
            ViewBag.añoPosterior = fechaInicio.AddMonths(1).Year;
            ViewBag.urlRetorno = httpContext.Request.Path + httpContext.Request.QueryString; //trae la url donde se encuentra el usuario
        }
        ...
        private (DateTime fechaInicio, DateTime fechaFin) GenerarFechaInicioYFin (int mes, int año)
        {
            ...
            return (fechaInicio, fechaFin); //devuelve dos valores de ese metodo
        }
    }
}
