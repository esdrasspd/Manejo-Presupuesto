...
namespace ManejoPresupuesto.Services
{
    public interface IRepositorioTiposCuentas
    {
        ...
        Task<IEnumerable<TipoCuenta>> GetTipos(int usuarioId);
    ...
    public class RepositorioTiposCuentas : IRepositorioTiposCuentas
    {
        ...
        public async Task Crear(TipoCuenta tipoCuenta)
        {
            ...
            var id = await connection.QuerySingleAsync<int>
                                                   ...
                                                   commandType: System.Data.CommandType.StoredProcedure); //procedimiento almacenado
            tipoCuenta.Id = id;
        }
        ...
        {
            using var connection = new SqlConnection(connectionString);
            var existe = await connection.QueryFirstOrDefaultAsync<int> //significa que hace una consulta del primer registro o primer valor por defecto
            (@"SELECT 1 
             FROM TiposCuentas 
        ...
        public async Task<IEnumerable<TipoCuenta>> GetTipos(int usuarioId)
        {
            ...
            //QueryAsync permite hacer un select y mapea los resultados en una clase
        }
        ...
        public async Task Actualizar(TipoCuenta tipoCuenta)
        {
            ...
            await connection.ExecuteAsync(@"UPDATE TiposCuentas 
                                          SET Nombre = @Nombre 
                                          WHERE id = @Id", tipoCuenta); //Execute permite ejecutar un query que no retorna nada
