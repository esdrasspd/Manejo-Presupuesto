...
namespace ManejoPresupuesto.Services
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>,
        IUserPasswordStore<Usuario> //nos obliga a implementar funcionalidades con el sistema de usuario
    {
        ...
        {
            return Task.FromResult(user.Email); //permite obtener el email del Usuario
        }
